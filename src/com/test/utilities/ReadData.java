...
public class ReadData {
	...
	public  List<String> testCaseStartTimeList = new ArrayList<String>();
	public  List<Integer> failCount = new ArrayList<Integer>();
	public  List<Integer> passCount = new ArrayList<Integer>();
	public  List<String> testCaseEndTimeList = new ArrayList<String>();
	public  List<String> testCaseNameList = new ArrayList<String>();
	public  List<String> testCaseDescriptionList = new ArrayList<String>();
	...
	public  List<String> testStepElapsedTimeList = new ArrayList<String>();
	public static List<String> testCaseElapsedTimeList = new ArrayList<String>();
	public static File snapShotFolder;
	public  List<String> snapShotPathList = new ArrayList<String>();
	public static  Map<String, String> statusMap = new HashMap<String, String>();
	public  List<String> stepCount = new ArrayList<String>();
	public  List<String> stepDescription = new ArrayList<String>();
	public  List<String> stepDescription1 = new ArrayList<String>();

	public  List<String> stepPrequisite = new ArrayList<String>();
	public  List<String> stepExpected = new ArrayList<String>();
	public  List<String> stepActual = new ArrayList<String>();
	public  List<String> stepStatus = new ArrayList<String>();
	public  static List<String> stepStatus1 = new ArrayList<String>();

public  List<String> objectEvidence = new ArrayList<String>();
	public List<String> testCaseName = new ArrayList<String>();
	public  List<String> testCaseDesc = new ArrayList<String>();
	public static List<String> testCaseName1 = new ArrayList<String>();
	public static List<String> testFullName= new ArrayList<String>();
	public static List<String> testmethod1 = new ArrayList<String>();
	...
	public void generateSuiteResultFolder()
	{
		...
		if (!suiteFolder.exists())
			suiteFolder.mkdir();
		File testFolder = new File(suiteFolder + "/" + testCaseReportsFolder);
	...
	public  void readTestDataFile(String filePath, String tcID) throws Exception{
		...
		try{
			...
			for(s=0; s<sheets; s++ ){
			XSSFSheet worksheet1 = (XSSFSheet) workbook.getSheetAt(s);
			String str=workbook.getSheetName(0);
			System.out.println(str);
			if(str.contains("PreCondition"))
			{
				worksheet1=(XSSFSheet) workbook.getSheet(str);
				Row Headertrow = worksheet1.getRow(0);
				int totalrows = 0;
				for(int i=1;i<=totalrows;i++){
				Row currentrowww = worksheet1.getRow(1);
			...
			{
				worksheet1=(XSSFSheet) workbook.getSheet(str1);
				Row Headertrow = worksheet1.getRow(0);
				@SuppressWarnings("null")
				int totalrows = worksheet1.getFirstRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
				int endValue=startValue; 
				for(int i=startValue; i<=endValue;i++){
					Row currentrow = worksheet1.getRow(i);
	...
	public void DefaultReport(String string) {
