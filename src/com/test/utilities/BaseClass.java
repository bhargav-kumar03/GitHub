...
public class BaseClass {
	...
	public int totalitemsdropdownlist(WebElement elem) throws Exception  {
	...
	public static void verifyElementIsEnabled(WebElement elem, boolean paramBoolean) throws Exception 
	{
		try
		{
	...
	public  void handleConfirmation(String paramString) throws Exception 
	{
	...
	public void switchBackToOriginalBrowser() throws Exception 
	{
		try{
	...
	public int getTableRowCount(String tableid) throws Exception 
	{ 
		int iRowCount=0;
		try
		{
	...
	public void VerifyText(WebElement elem, String paramString2) throws Exception
	{
		try
		{
	...
	{ 
		...
		System.out.println(System.getProperty("user.dir")+"\\FrameWork_Selenium\\TestData.xlsx");
